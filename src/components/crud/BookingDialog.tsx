...
export default function BookingDialog({ open, initial, beds, residents, properties = [], onClose, onSave }: Props) {
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent>
        <Grid container spacing={2} sx={{ mt: 0.5 }}>
          ...
          <Grid size={{ xs: 4 }}>
            <TextField label="Check-in *" type="date" value={form.checkInDate} onChange={e => { set('checkInDate', e.target.value); set('bedId', ''); }} fullWidth size="small" slotProps={{ inputLabel: { shrink: true } }} />
          </Grid>
          <Grid size={{ xs: 4 }}>
